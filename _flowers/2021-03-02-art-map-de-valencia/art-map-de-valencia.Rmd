...
description: |
   Siguiendo el código de [este post](https://ggplot2tutor.com/viz-pages/streetmaps/streetmaps/)
   de [Christian Burkhart](https://christianburkhart.de/) hago una visualización de las calles de Valencia: un streetmap.
...
preview: imagenes/preview2_aRt_map_valencia.png
twitter:
  creator: "@pjpv4444"
...
Primer post del renacido blog **R & flowers**
