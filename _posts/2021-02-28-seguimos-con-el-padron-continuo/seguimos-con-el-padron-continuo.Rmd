...
Para las secciones censales hay disponibles también seis tablas, parecidas a las que hay para los municipios, pero se centran más en la nacionalidad, además hay un fichero por año y sólo están disponibles en formato PC-Axis, mientras que las de municipios se pueden descargar en varios formatos.
...
El INE ofrece estas tablas en un fichero para el periodo 2015-2020 y un fichero individual para años anteriores. 
