...
description: |
  Se descargan y arreglan los datos del Nomneclator del INE. Los necesito para ver la evolución de la población de mi pueblo, Pancrudo. O ¿es municipio? ¿o entidad singular? ¿o nucleo? Para mi es mi pueblo diga lo que diga el INE.
author:
  - name: Pedro J. Pérez
...
twitter:
  creator: "@pjpv4444"
categories: [datos INE, Nomenclator, municipios]
output:
