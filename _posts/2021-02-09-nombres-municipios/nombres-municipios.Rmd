...
[Vuelvo a rescribir este post el 21 de febrero].  Han pasado unos días y resulta que ya he procesado los datos de población municipal ^[Los procesé para redactar el segundo post del blog], así que ya se contestar a las 2 preguntas.

¿Qué cuantos municipios han cambiado su nombre? Como puede verse en la tabla de abajo, de los 8.131 municipios que había en España en 2020, 914 de ellos, el 11,23%, cambiaron alguna vez de nombre.
