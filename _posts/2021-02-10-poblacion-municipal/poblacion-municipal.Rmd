---
title: "Población municipal 2000-2020"
description: |
  Se descargan y arreglan los datos de población municipal procedentes de la estadística del Padrón continuo. El INE ofrece los datos en un único fichero .zip que contiene 24 archivos, uno para cada año con datos: 1996 y 1998 a 2020. Trás unos pequeños problemas se fusionan los datos en un único fichero. Con él se realiza una coropleta con el crecimiento de la población municipal durante el periodo 2000-2020. En el mapa se aprecia que las zonas donde ha crecido más la poblacion son el litoral mediterraneo, Canarias, Baleares, zona de influencia de Madrid y en menor media el País Vasco.
author:
  - name: Pedro J. Pérez
...
twitter:
  creator: "@pjpv4444"
categories: [datos INE, Padron continuo, municipios, poblacion, poblacion municipal]
output:
...
```{r, eval = FALSE, layout="l-page", code_folding = TRUE}
...
ggsave(p, filename = here::here("plots", "2021_02_10_poblacion_municipal_01a.png"), 
       device = "png", width = 29, height = 20, units = "cm")
knitr::plot_crop(here::here("plots", "2021_02_10_poblacion_municipal_01a.png"))
```


```{r, echo = FALSE, layout="l-page"}
knitr::include_graphics("./plots/2021_02_10_poblacion_municipal_01a.png")
```
