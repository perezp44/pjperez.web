...
#- coger algun truco de Ariane Aumaitre: https://github.com/aaumaitre/tuto-R-iales/blob/main/mapa_es.R
#- aaumetre de canarias: https://github.com/aaumaitre/maps_Spain
#- otro del traslado de Canarias: https://procomun.wordpress.com/2012/02/18/maps_with_r_1/comment-page-1/
